...
import { GitHubAuthorizeParams, GitHubAuthorizeResponse, GitHubAuthorizeURLResponse, GoogleAuthorizeParams, GoogleAuthorizeResponse, GoogleAuthorizeURLResponse } from "@/types/oauth";
...
class OAuthService {
  ...
  async githubAuthorize(data: GitHubAuthorizeParams): Promise<GitHubAuthorizeResponse> {
  ...
  async googleAuthorize(data: GoogleAuthorizeParams): Promise<GoogleAuthorizeResponse> {
