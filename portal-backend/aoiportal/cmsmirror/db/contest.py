...
class Contest(Base):
    ...
    submissions_download_allowed = Column(Boolean, nullable=False, default=True)
    ...
    block_hidden_participations = Column(Boolean, nullable=False, default=False)

    # Whether to allow username/password authentication
    allow_password_authentication = Column(Boolean, nullable=False, default=True)

    # Whether to allow sso authentication
    allow_sso_authentication = Column(Boolean, nullable=False, default=False)

    sso_secret_key = Column(String, nullable=False, default="")

    sso_redirect_url = Column(String, nullable=False, default="")
    ...
    analysis_start = Column(DateTime, nullable=False, default=datetime(2030, 1, 1))
    analysis_stop = Column(DateTime, nullable=False, default=datetime(2030, 1, 1))
    ...
    per_user_time = Column(
        Interval, CheckConstraint("per_user_time >= '0 seconds'"), nullable=True
    )
