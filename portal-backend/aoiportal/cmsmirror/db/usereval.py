...
class UserEval(Base):
    ...
    participation = relationship(Participation, back_populates="user_evals")
...
class UserEvalFile(Base):
    ...
    __table_args__ = (UniqueConstraint("user_eval_id", "filename"),)
    ...
    user_eval_id = Column(
        Integer,
        ForeignKey(UserEval.id, onupdate="CASCADE", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    user_eval = relationship(UserEval, back_populates="files")
...
class UserEvalResult(Base):
    ...
    __table_args__ = (UniqueConstraint("user_eval_id", "dataset_id"),)
    ...
    user_eval = relationship(UserEval, back_populates="results")
...
class UserEvalExecutable(Base):
    ...
    user_eval = relationship(UserEval, viewonly=True)
    ...
    user_eval_result = relationship(UserEvalResult, back_populates="executables")
